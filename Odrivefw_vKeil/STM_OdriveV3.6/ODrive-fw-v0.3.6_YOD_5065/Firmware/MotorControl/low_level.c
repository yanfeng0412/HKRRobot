...
#if APP_USE_HALL_SENSOR
        .hall = {
            .hallA_port   = APP_HALL_A_PORT,
            .hallA_pin    = APP_HALL_A_PIN,
            .hallB_port   = APP_HALL_B_PORT,
            .hallB_pin    = APP_HALL_B_PIN,
            .hallC_port   = APP_HALL_C_PORT,
            .hallC_pin    = APP_HALL_C_PIN,
            .motor_dir    = APP_HALL_MOTOR_DIR,
            .phase_offset = APP_HALL_PHASE_OFFSET,
        },
#endif
        .loop_counter = 0,
        .timing_log = { 0 },
